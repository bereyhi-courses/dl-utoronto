...
description: (Old Recording) We can look at the attention mechanism as a processing unit. Interestingly, we can ignore the time connection and perform the complete process in parallel with high efficiency. This is the building block of the transformers. We introduce this module in this lecture and understand it's efficiency. 
videoID: 7wf2fb-GHk4 
