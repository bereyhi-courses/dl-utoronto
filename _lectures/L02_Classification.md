...
title: "Lecture 2: Classification via Perceptron"
tldr: "Classification"
stat: lec
# for lectures stat: lec
description: We complete the remaining components of ML, i.e., model and loss. We then get into the example of image classification. We try to understand the ML components for the example of Perceptron.
videoID:  U9Zf7ArpAvk 
