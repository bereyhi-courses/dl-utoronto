...
title: "Lecture 30: Gated Architectures"
tldr: "Gating"
stat: lec
# for lectures stat: lec
description: We see the gating principle as a key idea to extend the memory through time. This idea leads to LSTM and GRU architectures. We study computational models with Gating. We look into GRU and LSTM in particular, study their training, and see how we can make them bidirectional.
videoID: z_BeIMwuIG0 
hide_from_announcments: false
---
**Lecture Notes:**
- [Chapter 6 - Section 4]({{ site.baseurl }}/assets/Notes/CH6/CH6_Sec4.pdf) 
- [Chapter 6 - Section 5]({{ site.baseurl }}/assets/Notes/CH6/CH6_Sec5.pdf) 
