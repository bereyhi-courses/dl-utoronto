<!-- ---
type: lecture
date: 2025-09-05T12:10:00
title: "Lecture 6: First Example -- Classification by Perceptron"
tldr: "Classification"
stat: lec
# for lectures stat: lec
description: We now take our first example --that is image classification. We see how the data looks like in this case. We further build a computational model called Perceptron for it and specify the loss. 
videoID: k4SxpYpVFjM 
