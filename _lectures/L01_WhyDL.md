...
description: This lecture gives a short motivating introduction to deep learning. We then go through a dummy example and learn the basic components of DL. 
videoID: uUrz8GI0lOs 
