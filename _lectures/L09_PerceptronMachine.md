...
tldr: "Perceptron Algorithm"
stat: lec
# for lectures stat: lec
description: We next train the perceptron machine. We see that the training in this case minimizes the error rate on the dataset. We study the Perceptron Algorithm by Rosenblatt, which is the most simple form of a gradient-based training algorithm. 
videoID: ikeGcEJ8UaY 
